    ...
    return (
        <>
            <div className="w-full h-screen sm:justify-center items-center flex flex-col gap-2 py-4 sm:py-0 transition-all">
                <div className={`rounded-4xl relative bg-zinc-100 dark:bg-zinc-900 sm:border w-96 sm:w-92 dark:border-zinc-800 drop-shadow-xl p-4 transition-all duration-500 ease-in-out overflow-hidden `}>
                    {!success ? (
                        <div className="flex justify-between items-center">
                            ...
                            <Link to='../' className=" p-1.5 dark:hover:bg-zinc-800 hover:bg-zinc-200 rounded-lg transition-all duration-300 cursor-pointer" >
                            ...
                            <div className={`py-3 flex flex-col gap-2 w-full sm:w-84 transition-all duration-500 transform`}>
                                ...
                                <form className="flex flex-col gap-2">
                                    ...
                                    <div className="flex justify-center w-full mt-2">
                                        <div className="text-xs text-zinc-600 dark:text-zinc-400">Already have an account? <Link to="../" className="text-sky-600 hover:underline">Sign In</Link></div>
                                    </div>
                                </form>
                            </div>
                        ) : (
