import { Mail, ScanFace, Lock, Eye, EyeOff, Github } from "lucide-react"
...
function SignIn() {
    ...
    return (
        <>
            <div className="w-full h-screen sm:justify-center items-center flex flex-col gap-4 py-8 sm:py-0">
                <div className="p-3 rounded-full bg-zinc-950 dark:bg-white">
                    <ScanFace className="w-7 h-7 text-white dark:text-black" />
                </div>
                <h1 className="text-xl">Sign in to SkillStack</h1>
                <div className="p-4 sm:py-6 sm:border rounded-xl flex flex-col gap-2 w-full sm:w-84 shadow-xl">
                    ...
                    <form className="flex flex-col gap-2">
                        ...
                        <div className="flex justify-center w-full mt-2">
                            <div className="text-xs text-zinc-600 dark:text-zinc-400">Don't have an account? <a href="./signup" className="text-sky-600">Sign Up</a></div>
                        </div>
                    </form>
                </div>
            </div>
