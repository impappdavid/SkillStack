    ...
    return (
        <>
            <div className="w-full h-screen sm:justify-center items-center flex flex-col gap-2 py-4 sm:py-0 transition-all">
                <div className={`rounded-4xl relative bg-zinc-900 sm:border border-zinc-800 drop-shadow-xl p-4 transition-all duration-500 ease-in-out overflow-hidden ${showOtpInput ? "max-h-[200px]" : "max-h-[500px]"}`}>
                    <div className="flex justify-between items-center">
                        {showOtpInput ? (
                            <div className=" p-1.5 dark:hover:bg-zinc-800 rounded-lg transition-all duration-300 cursor-pointer" onClick={goBackHandle}>
                    ...
                    <div className="relative">
                        {showOtpInput ? (
                            <div className={`py-3 flex flex-col items-center gap-2 w-full sm:w-84 shadow-xl transition-all duration-500 transform ${isFormVisible ? 'translate-x-0 opacity-100' : 'translate-x-2 opacity-0 pointer-events-none'}`}>
                            ...
                            <div className={`py-3 flex flex-col gap-2 w-full sm:w-84 shadow-xl transition-all duration-500 transform ${isFormVisible ? 'translate-x-0 opacity-100' : '-translate-x-2 opacity-0 pointer-events-none'}`}>
