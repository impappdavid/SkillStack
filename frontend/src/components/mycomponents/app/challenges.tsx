    ...
    return (
        <>
            <div className="px-0 py-4 w-64 h-screen hidden sm:flex flex-col gap-4 fixed top-2 ">
                <div className="p-3 border rounded-lg dark:bg-zinc-900/20 bg-zinc-100 flex flex-col gap-2">
                    <div className="text-lg font-medium">Active problems</div>
                    <Separator />
                    <div className="flex flex-col gap-1">
                        <div className="px-3 py-2 flex justify-between items-center rounded-md cursor-pointer dark:hover:bg-zinc-800/40 hover:bg-zinc-200 transition-all duration-300">
